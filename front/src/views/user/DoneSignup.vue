<template>
  <div class="user" id="donesignup">
    <svg fill="#42A5F5" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="100px" height="100px">    
    ...
    <h1>환영합니다</h1>
    <div>투게더홈트 가입이 완료되었습니다.</div>
    <button class="user-btn" @click="goLogin()">로그인</button>
  </div>
</template>
