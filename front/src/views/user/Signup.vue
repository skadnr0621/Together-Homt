  ...
  <div class="user" id="signup">
    ...
    <div>
      <div class="input-with-label" id="short">
        ...
        <input class="signup-input-data" v-model="user.username" id="nickname" placeholder="닉네임을 입력하세요." type="text">
      </div>
      ...
      <div class="input-with-label" id="short">
        ...
        id="email" placeholder="이메일을 입력해주세요." type="text">
      </div>
      ...
      <div class="input-with-label">
        ...
        <input class="signup-input-data" v-model="inputConfirmNum" id="input-confirmnum" placeholder="인증번호를 입력하세요." type="text">
        <div v-if="isSendNum">
          <!-- 확인 -->
          <button class="send-confirmNum" @click="emailConfirm()" id="input-confirmnum-btn"><p class="font-scale-8">확인</p></button>
          <!-- 재전송 -->
        </div>
        <div v-else>
          <button class="send-confirmNum" @click="sendConfirm()"><p class="font-scale-8">인증번호 받기</p></button>
        </div>
      </div>

      <div class="input-with-label" id="short">
        <input class="signup-input-data" v-model="user.password" id="password" placeholder="비밀번호를 입력하세요.(영문 + 숫자 6자리)" type="text">
        <label for="password">비밀번호</label>
      </div>

      
      <div class="input-with-label">
        <input class="signup-input-data" 
    ...
    <div class="checkbox">
      ...
      <label for="checkbox"><strong>이용약관</strong> 및 <strong>개인정보 처리방침</strong>에 동의합니다.</label>
    </div>
    ...
    <div class="end-text-signup">
      ...
      <router-link :to="{ name: 'Login'}" class="link-go-signup"><strong>로그인</strong></router-link>
    </div>
  </div>
</template>
